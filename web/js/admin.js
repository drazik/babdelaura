...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imageUpload = __webpack_require__(6);

	var _imageUpload2 = _interopRequireDefault(_imageUpload);

	var _ContentTools = __webpack_require__(26);

	var _ContentTools2 = _interopRequireDefault(_ContentTools);

	var _imagesGallery = __webpack_require__(27);

	var _imagesGallery2 = _interopRequireDefault(_imagesGallery);
	...
	var imageUploadContainers = [].concat(_toConsumableArray(document.querySelectorAll('.js-image-upload')));
	imageUploadContainers.forEach(function (container) {
	    return new _imageUpload2.default(container);
	});

	var imagesGalleryContainers = [].concat(_toConsumableArray(document.querySelectorAll('.js-images-gallery')));
	imagesGalleryContainers.forEach(function (container) {
	    return new _imagesGallery2.default(container);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageUpload = function () {
	    function ImageUpload(container) {
	        ...
	        this.form = new _xhrForm2.default(this.container.querySelector('.js-image-upload-form'), {
	    ...
	    _createClass(ImageUpload, [{
	        ...
	        value: function handleUploadError(error) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImagesGallery = function () {
	    function ImagesGallery(container) {
	        var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
