...
/***/ function(module, exports, __webpack_require__) {
	...
	var _previewModalImagePicker = __webpack_require__(28);

	var _previewModalImagePicker2 = _interopRequireDefault(_previewModalImagePicker);

	var _wysiwygEditor = __webpack_require__(31);
	...
	new _wysiwygEditor2.default('*[data-editable]', 'data-name');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imagesList = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PreviewModalImagePicker = function () {
	    ...
	    _createClass(PreviewModalImagePicker, [{
	        key: 'onItemSelect',
	        value: function onItemSelect(src) {
	            this.setPreview(src);
	        ...
	        key: 'setInputValue',
	        value: function setInputValue(src) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContentTools = __webpack_require__(32);
	...
	var WYSIWYGEditor = function () {
	    function WYSIWYGEditor(selector, name) {
	        _classCallCheck(this, WYSIWYGEditor);

	        this.initTools();

	        this.editor = _ContentTools2.default.EditorApp.get();
	    ...
	    _createClass(WYSIWYGEditor, [{
	        ...
	        value: function initTools() {
	            _ContentTools2.default.ToolShelf.stow(new ImagePickerTool(), 'image');

	            _ContentTools2.default.DEFAULT_TOOLS = [['bold', 'italic', 'link', 'align-left', 'align-center', 'align-right'], ['heading', 'subheading', 'paragraph', 'unordered-list', 'ordered-list', 'table', 'indent', 'unindent', 'line-break'], ['image'], ['undo', 'redo', 'remove']];
	        }
	    }, {
	        key: 'initEvents',
	        value: function initEvents() {
	...
	var ImagePickerTool = function (_ContentTools$Tool) {
	    _inherits(ImagePickerTool, _ContentTools$Tool);

	    function ImagePickerTool() {
	        _classCallCheck(this, ImagePickerTool);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ImagePickerTool).call(this));
	    ...
	    _createClass(ImagePickerTool, [{
	        ...
	        key: 'isApplied',
	        value: function isApplied() /*element, selection*/{
	            // TODO
