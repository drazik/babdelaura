...
const imageUploadListContainers = [
  ...document.querySelectorAll(".js-image-upload-list")
];
imageUploadListContainers.forEach(container => new ImageUploadList(container));

const previewModalImagePickerContainers = [
  ...document.querySelectorAll(".js-preview-modal-image-picker")
];
previewModalImagePickerContainers.forEach(
  container => new PreviewModalImagePicker(container)
);

const wysiwygEditorContainers = [
  ...document.querySelectorAll(".js-wysiwyg-editor")
];
wysiwygEditorContainers.forEach(container => new WYSIWYGEditor(container));

const imagePickerContainers = [
  ...document.querySelectorAll(".js-image-picker")
];
imagePickerContainers.forEach(container => new ImagePicker(container));

const autocompleteContainers = [
  ...document.querySelectorAll(".js-autocomplete")
];
